...
import { CustomSearchBar } from '../searchbar/custom-search';
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Box
          width={{ base: '95%', md: '90%', lg: '70%' }} // Slightly wider on mobile
          position={{ base: 'relative', md: 'absolute' }}
          bottom={{ base: '0', md: '-80px' }} // Adjusted bottom for better spacing
          left='50%'
